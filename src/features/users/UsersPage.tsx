...
const UsersPage: React.FC = () => {
  ...
  if (error) return <div className="text-red-500 p-8">Error loading users: {error}</div>;
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-display font-bold text-secondary-800 dark:text-white">Users</h1>
        <p className="text-secondary-600 dark:text-secondary-400 mt-1">Manage your users</p>
      </div>
        ...
        <div className="p-6">
          {filteredUsers.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-lg font-medium text-secondary-900 dark:text-secondary-200">No users found</h3>
